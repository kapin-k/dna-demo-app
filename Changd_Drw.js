 ...
 <View style={{flexDirection: 'row' , justifyContent: 'space-around'}}>
  ...
  <Text style={{
    ...
    <Text style={{
          ...
          <View style={{ height: 450, padding: 20, marginTop: 0, flexDirection: 'row' , flexWrap: 'wrap'}}>
                <View style={{ flexDirection: 'column', alignContent: 'space-around' }}>
        <View style={{width: 50, height: 120, backgroundColor: '#F8F8F8'}} > 
        ...
        <Text style={{width: 50, height: 50,  fontSize: 23, color:'black'}}>-2</Text> 
          ...
          <View style={{ padding: 87, flexDirection: 'column'}}>
            ...
            <View style={{width: 260, height: 0, backgroundColor: '#F8F8F8'}} >
